...
The described example from above, is depicted in figures \ref{f:2d_no_filter_1} and \ref{f:2d_filter_1}, in which the impact of the filters is obvious.
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=\columnwidth]{figures/2d_no_filter_1.png}
  \captionof{figure}{Histogram on \textit{Patient Age} and \textit{Height (cm)} with no filters}
  \label{f:2d_no_filter_1}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=\columnwidth]{figures/2d_filter_1.png}
...
The effect of this example can be found in figures \ref{f:2d_no_filter_2} and \ref{f:2d_filter_2}.

\begin{figure}
\centering
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=\columnwidth]{figures/2d_no_filter_2.png}
  \captionof{figure}{Histogram on \textit{BMI (kg/msq)} with no filters}
  \label{f:2d_no_filter_2}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=\columnwidth]{figures/2d_filter_2.png}
...
\fixme{Check the algorithm for bugs}

\fixme{This algorithm is 2D. Maybe switch to 1D for simplicity??}
