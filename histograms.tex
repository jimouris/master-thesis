...
The procedure described in \ref{ss:histogram-algos} is shown in algorithm \ref{a:1d-simple-histogram}.
This algorithm iterates through all $N$ items and checks all possible cells for that item.
When the correct cell is found, it increments the corresponding counter.

\import{./}{algorithms/hist_simple.tex}

This algorithm is straightforward and simple to understand, however, not very efficient.
