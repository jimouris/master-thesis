...
In contrast, the privacy preserving algorithm (PIR) is not able to return before searching the whole database without without revealing any information about the key and the result.
