...
\textbf{Secure Aggregation for CVI:} After selecting the secure aggregation for the CVI (numerical) dataset, the researcher has to choose attributes, filters and data\hyp providers for the privacy computation, as in figure \ref{f:cvi-histogram}.
