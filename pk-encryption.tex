...
One if the first and most widely adopted public key cryptosystem is RSA \cite{rivest1978method} named after its authors Rivest, Shamir and Adleman. The algorithm's difficulty reduces to the difficulty of factoring the product of two large prime numbers.
\begin{itemize}
