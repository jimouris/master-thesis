...
\end{minted}
\captionof{lstlisting}{Non-vectorized array addition in SecreC}\label{l:non_vectorized_addition}
}
...
\end{minted}
\captionof{lstlisting}{Vectorized array addition in SecreC}\label{l:vectorized_addition}
}
