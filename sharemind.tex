...
void main(){
  pd_shared3p uint64 x1 = 5; // Private, secret-shared value if input party 1
  pd_shared3p uint64 x2 = 8;  // Private, secret-shared value if input party 2
  pd_shared3p uint64 max = max(a, b); // Private result
