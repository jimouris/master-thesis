...
\Procedure{MultDimHistogramNum}{${\color{darkred}{array}}[N][M], attributes[A], $\par\hspace{6.4cm}$cellsPerAttribute[A], {\color{darkred}{mins}}[M], {\color{darkred}{maxs}}[M]$} 
% \Procedure{MultDimHistogramNum}{${\color{darkred}{array}}[N][M], attributes[A], $\par\hfill$cellsPerAttribute[A], {\color{darkred}{mins}}[M], {\color{darkred}{maxs}}[M]$} 
    \State
