...
\Procedure{Best}{${\color{darkred}{examples}}, attribute$}\Comment{\small{Find the best attribute; the one with maximum \par\hfill information gain, as public data}}
    ...
    \For{$attribute \in attributes$}
        ...
        \State ${\color{darkred}{maxGain}} \gets {\color{darkred}{gt}} \hmul {\color{darkred}{gain}} \hplus (1 - {\color{darkred}{gt}}) \hmul {\color{darkred}{maxGain}}$ \Comment{\small{Obliviously choose maximum gain}}
        \State ${\color{darkred}{best}} \gets {\color{darkred}{gt}} \hmul attribute \hplus (1 - {\color{darkred}{gt}}) \hmul {\color{darkred}{best}}$\Comment{\small{Obliviously choose best attribute}}
    \EndFor
