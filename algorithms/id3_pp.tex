...
\Procedure{ID3}{${\color{darkred}{examples}}, attributes$}
   ...
   \ElsIf {$attributes = \{\}$}
        \State \textbf{return} ${\color{darkblue}{\textsc{Declassify}}}(\textsc{MostCommonLabel}({\color{darkred}{examples}}))$\Comment{\small{Return the most common \par\hfill  class in the dataset}}
    \EndIf
