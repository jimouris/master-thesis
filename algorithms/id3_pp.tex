...
\Procedure{ID3}{${\color{darkred}{examples}}, attributes$}
   ...
   \ElsIf {$attributes = \{\}$}
        \State \textbf{return} ${\color{darkblue}{\textsc{Declassify}}}(\textsc{MostCommonLabel}({\color{darkred}{examples}}))$\Comment{\small{Return the label with the most common \par\hfill value of the target attribute in the examples}}
    \EndIf
