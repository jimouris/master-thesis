...
Πιο συγκεκριμένα, έχουμε υλοποιήσει αλγορίθ\hyp μους ειδικά σχεδιασμένους για κρυπτογραφημένες αρχιτεκτονικές, χρησιμοποιώντας το σενάριο του Ασφαλή Υπολογισμού Πολλών Συμμετεχόντων, όπως ασφαλείς συγκεντρωτ\hyp ικούς αλγορίθμους και ασφαλείς κατηγοριοποιητές με δέντρα απόφασης.
